    ...
    <body class="right-sidebar">
        ...
        <div id="header-wrapper">
            <div id="header">
                ...
                <!-- Logo -->
                <header>
                    <a href="index.php" title="Home"><img src="images/LincolnAtheistsFullColorLogo.svg" alt="Lincoln Athists Logo"></a>
                </header>
                ...
                <div class="row">
                    <div class="8u">
                        ...
                        <article class="box post">
                            ...
                            <section>
                                ...
                                <p>
                                    Lincoln Atheists (LA) organizes monthly and weekly social events. 
                                </p>
                            ...
                            <section>
                                ...
                                <div id="amznCharityBanner"><script type="text/javascript">(function () {
                    ...
                    <div class="4u">
                        ...
                        <section class="box">
                            ...
                            <script class="ai1ec-widget-placeholder" data-widget="ai1ec_agenda_widget" data-events_seek_type="events" data-events_per_page="5">
                                (function () {
